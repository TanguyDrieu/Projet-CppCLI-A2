...
namespace NS_Composants
{
	...
	{
		return "SELECT ID_PERSONNEL, ID_SUPERIEUR, NOM_PERSONNEL, PRENOM_PERSONNEL, ADRESSE_MAIL_PERSONNEL, DATE_EMBAUCHE " +
			"FROM PERSONNEL;";
	}
	String^ PERSONNEL::SELECTPERSONNELADRESSE(void)
	{
		return "SELECT ID_PERSONNEL, dbo.PERSONNEL.ID_ADRESSE, ID_SUPERIEUR, NOM_PERSONNEL, PRENOM_PERSONNEL, ADRESSE_MAIL_PERSONNEL, DATE_EMBAUCHE, ADRESSE.RUE, ADRESSE.CODE_POSTAL, ADRESSE.VILLE " +
	...
	String^ PERSONNEL::INSERT(void)
	{
		return "INSERT INTO PERSONNEL " +
			"(ID_SUPERIEUR, ID_ADRESSE, NOM_PERSONNEL, PRENOM_PERSONNEL, ADRESSE_MAIL_PERSONNEL, DATE_EMBAUCHE) " +
			"VALUES('" + this->getID_SUP() + "', '" + this->getID_ADRESSE() + "', '" + this->getNOM_PERSONNEL() + "', '" + this->getPRENOM_PERSONNEL() + "', '" + this->getADRESSE_MAIL_PERSONNEL() + "', '" + this->getDATE_EMBAUCHE() + "');SELECT @@IDENTITY;";
	}
	...
	int PERSONNEL::getID_SUP(void)
	{
		return this->ID_SUPERIEUR;
	}
	void PERSONNEL::setID_SUP(int ID_SUP)
	{
		this->ID_SUPERIEUR = ID_SUP;
	}
	int PERSONNEL::getID_ADRESSE(void)
	{
	...
	void PERSONNEL::setID_ADRESSE(int ID_ADRESSE)
	{
