...
namespace NS_Composants
{
	...
	{
		return "SELECT ID_CLIENT, NOM_CLIENT, PRENOM_CLIENT, DATE_NAISSANCE_CLIENT, DATE_PREMIERE_COMMANDE_CLIENT,ADRESSE_FAC.RUE AS RUE_FAC, ADRESSE_FAC.CODE_POSTAL AS CODE_POSTAL_FAC, ADRESSE_FAC.VILLE AS VILLE_FAC, ADRESSE_LIV.RUE AS RUE_LIV, ADRESSE_LIV.CODE_POSTAL AS CODE_POSTAL_LIV, ADRESSE_LIV.VILLE AS VILLE_LIV "
			"FROM dbo.CLIENT  INNER JOIN dbo.ADRESSE AS ADRESSE_FAC ON(dbo.client.ID_CLIENT = ADRESSE_FAC.ID_CLIENT_FACTURATION) " +
			"INNER JOIN dbo.ADRESSE AS ADRESSE_LIV ON(dbo.CLIENT.ID_CLIENT = ADRESSE_LIV.ID_CLIENT_LIVRAISON)";
